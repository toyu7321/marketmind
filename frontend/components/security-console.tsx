...
import {createTotpQrCode, extractTotpSetupKey, maskedTotpSetupKey} from '@/lib/mfa';
...
export function SecurityConsole() {
  ...
  async function verify(event: FormEvent) {
    ...
    if (!result.error) { setTotpUri(''); setShowManualSetup(false); setManualSetupKey(''); setRevealManualKey(false); setCode(''); refresh(); }
  }
