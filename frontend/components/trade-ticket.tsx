...
import {normalizePortfolio, PortfolioData, PortfolioOrder} from '@/lib/portfolio';
...
export function TradeTicket() {
  ...
  const load = () => api<unknown>('/portfolio').then(payload => setPortfolio(normalizePortfolio(payload))).catch(() => setMessage('Could not synchronize the paper account.'));
  useEffect(() => { void load(); }, []);
